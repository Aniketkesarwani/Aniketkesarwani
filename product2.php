...
if(isset($_GET['id'])){
	...
	$sqlselect="select * from halfpricebook where id=$id";
...
<meta name="keywords" content="halfpricebook,sell,buy,books">
...
<gcse:search></gcse:search></div>
    ...
    <div class="content">
    	<div class="section group">
			...
			<iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Fstudream.in/product2.php?id=<?php echo $i['id']; ?>&layout=button&size=large&mobile_iframe=true&width=72&height=28&appId" width="72" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
<iframe
  src="https://platform.twitter.com/widgets/tweet_button.html?size=l&url=http%3A%2F%2Fstudream.in/product2.php?id=<?php echo $i['id']; ?>&related=twitterapi%2Ctwitter&text=<?php echo $i['Title']; ?>&hashtags=Studream"
  width="72"
  height="28"
...
<script type="IN/Share" data-url="http://studream.in/product2.php?id=<?php echo $i['id']; ?>" data-counter="right"></script>

<!-- Place this tag in your head or just before your close body tag. -->
<script src="https://apis.google.com/js/platform.js" async defer></script>
<!-- Place this tag where you want the share button to render. -->
<div class="g-plus" data-action="share" data-href="http://studream.in/product2.php?id=<?php echo $i['id']; ?>"></div>
			<div class="clear"></div>
		  </div>
		  <center>
