...
<html>
<head>
<title>Fitness And Gym-Studream</title>
...
<meta name="keywords" content="fitness,gym,classes,yoga,student,bookshop,sell,buy,ads,profit,studream,advertisement,online advertisement">
						   ...
						   <div>
							...
							<ul class="list">
								<a href="product.php?id=41">
									...
									<h5 class="title">Learn yoga at home from a professional yoga instructor....</h5>
										<p class="catpath">Yoga at home</p>
									<p class="catpath">Fitness and Gym » Brand</p>
									</section>
									<section class="list-right">
									<span class="cityname">City->Ellena Lasrado</span>
									</section>
									<div class="clearfix"></div>
									</li> 
								</a>
								<a href="product.php?id=41">
									<li>
									<img src="Uploads/IMG-20170909-WA0006.jpg" title="" alt="" />
									<section class="list-left">
									<h5 class="title">Bcum a master mover and super fit.unleash ur true potentiallearn with me calisthenics,athletics,marial arts,taekwondo n ....</h5>
										<p class="catpath">Bcum fit.bcum hit</p>
									<p class="catpath">Fitness and Gym » Brand</p>
									</section>
									<section class="list-right">
