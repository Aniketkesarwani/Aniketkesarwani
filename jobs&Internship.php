...
<html>
<head>
<title>Jobs And Internship-Studream</title>
...
<meta name="keywords" content="job,internship,online advertisement,free,advertisement,Classifieds,ads,post">
						   ...
						   <div>
							...
							<ul class="list">
								<a href="product.php?id=32">
									<li>
									<img src="Uploads/Screenshot_2017-03-25-00-30-01.png" title="" alt="" />
									<section class="list-left">
									<h5 class="title">Students will construct/build/design a novel apparatus to harness solar/wind energy. Further, the students are ....</h5>
										<p class="catpath">Solar Energy, Wind Energy Internship</p>
									<p class="catpath">Jobs And Internship » Brand</p>
									</section>
									<section class="list-right">
									<span class="cityname">City->Roorkee</span>
									</section>
									<div class="clearfix"></div>
									</li> 
								</a>
								<a href="product.php?id=31">
									<li>
									<img src="Uploads/Screenshot_2017-03-22-23-07-46.png" title="" alt="" />
									<section class="list-left">
									<h5 class="title">An Internship with UREDA(Uttrakhand Renewable Energy Development Agency) for 2nd and 3rd year machies ....</h5>
										<p class="catpath">UREDA(Uttrakhand Renewable Energy Development Agency)</p>
									<p class="catpath">Jobs And Internship » Brand</p>
									</section>
									<section class="list-right">
									<span class="cityname">City->Roorkee</span>
