...
<html>
<head>
<title>PG And Hostels-Studream</title>
...
<meta name="keywords" content="pg,hostel,promote pg,promote hostel,services,free,ads,advertisement,classified,free,online advertisement">
	...
	<div class="total-ads main-grid-border">
		<div class="container">
			...
			<ol class="breadcrumb" style="margin-bottom: 5px;">
			  <li><a href="index.php">Home</a></li>
			  <li><a href="PGAndHostels.php">PG And Hostels</a></li>
					...
					<h2 class="sear-head fer" style="color:#2E86C1">Featured Ads</h2>
						...
						<a href="product.php?id=25">
							<div class="featured-ad-left">
								<img src="Uploads/1487833845890420422483.jpg" title="ad image" alt="" />
							</div>
							<div class="featured-ad-right">
								<h4>This pg is only for girls. You will have all the support you need and a super nice host that is my mum</h4>
								<p>Rs 5000</p>
							</div>
							<div class="clearfix"></div>
						</a>
						...
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
						   <div>
							...
							<ul class="list">
								<a href="product.php?id=25">
									<li>
									<img src="Uploads/1487833845890420422483.jpg" title="" alt="" />
									<section class="list-left">
									<h5 class="title">This pg is only for girls. You will have all the support you need and a super nice host that is my mum</h5>
										<p class="catpath">Nice "homely" home</p>
										<span class="adprice">Rs 5000</span>
									<p class="catpath">PG And Hostels » Brand</p>
									</section>
									<section class="list-right">
									<span class="cityname">City->Patna</span>
									</section>
									<div class="clearfix"></div>
									</li> 
								</a>
