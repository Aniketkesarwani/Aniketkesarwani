...
<meta name="keywords" content="Contact,studream">
	...
	if(isset($_POST['Submit']))
{
	...
	$sql="insert into contactus values('$_POST[first]','$_POST[last]','$_POST[email]','$_POST[mob]','$_POST[message]')";
	mysqli_query($db_handle,$sql);
	$sqlselect="select * from contactus";
