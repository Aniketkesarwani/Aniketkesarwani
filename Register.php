	...
	<div class="header-top">
		...
		<div class="container">
			...
			<div class="post-ad-form">
			    ...
			    <span><input name="name" type="text" class="name" required data-validation-required-message="Please write your Full Name!" maxlength="90" placeholder="Enter your Name"></sapn>
						<div class="clearfix"></div>
				<span><input name="mob" type="text" class="phone" required data-validation-required-message="Please write your Phone number!" placeholder="Mobile No:"></span>
						<div class="clearfix"></div>
						<input name="email" type="text" class="email" required data-validation-required-message="Please write your Email Address!" placeholder="Enter email">
				<div class="clearfix"></div>
						<input name="pass" type="text" class="password" required data-validation-required-message="Please write your Password!" placeholder="Enter password">
				<div class="clearfix"></div>
				<input name="pass" type="text" class="password" required data-validation-required-message="Please write your Password!" placeholder="Confirm password">
				<div class="clearfix"></div>
						<?php
...
?>	
					...
					<div class="clearfix"></div>
					<p class="aa-lost-password" style="float:center">By Register, you accept our <a href="terms.html">Terms of Use</a></p>
					</form>
					</div>
			</div>
		</div>
				...
				<div class="container">
					<div class="foo-grids">
						...
						<div class="col-md-3 footer-grid">
							...
							<li><a href="HalfPriceBook.php">HalfPriceBooks</li>
							<li><a href="FreeTutorials.html">Free Tutorials</a></li>
						    <li><a href="VideoTutorials.html">Video Tutorials</a></li>
